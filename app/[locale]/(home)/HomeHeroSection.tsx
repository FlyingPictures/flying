  ...
  return (
    <section className="relative h-[95vh] lg:h-screen overflow-hidden pt-18 lg:pt-0">
      <div className="absolute inset-0 flex justify-center">
        <CloudinaryImage publicId={IMAGES.home.hero.background} alt="Hero Background" fill sizes="100vw" className="object-contain object-top" priority />
        <div className="absolute inset-0 bg-black/10" />
      </div>

      <div className="absolute inset-0 flex items-end justify-center px-[clamp(0.75rem,5vw,1.5rem)] text-center">
        <div className="w-full max-w-5xl flex flex-col items-center gap-[clamp(0.5rem,1vw,1.5rem)]" style={{ paddingTop: NAV_OFFSET, maxHeight: `calc(100vh - ${NAV_OFFSET})` }}>
          <CloudinaryImage publicId={IMAGES.home.hero.stars} alt="5 Stars" width={640} height={160} className="w-40 h-auto object-contain mb-2"  priority />
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            ...
            <Button variant="ghost" size="sm" className="hidden sm:inline-flex text-background"> {t("ctaSecondary")}
            </Button>
          </div>
