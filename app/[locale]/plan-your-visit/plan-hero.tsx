  ...
  return (
    <section className="relative h-[95vh] lg:h-screen overflow-hidden pt-[4.5rem]">
      <div className="absolute inset-0">
        <CloudinaryImage publicId={IMAGES.plan.hero.background} alt="Hero Background" fill priority sizes="100vw" className="h-full w-auto object-contain object-top" />
        <div className="absolute inset-0 bg-black/10" />
      </div>

      <div className="absolute inset-0 flex items-end justify-center text-center pb-40">
        <div className="w-full max-w-[1200px] flex flex-col items-center gap-4 sm:gap-8 px-6" style={{ paddingTop: NAV_OFFSET, maxHeight: `calc(100vh - ${NAV_OFFSET})` }}>
